...
//     {
//       content: "Hi there! I'm Manas, your mental health assistant. How are you feeling today?",
//       isUser: false,
//       timestamp: new Date()
//     }
//   ]);
...
//         if (data.reply && data.reply.type === 'formatted') {
//           responseContent = data.reply; // Use formatted reply
//         } else if (data.response && typeof data.response === 'object' && data.response.type === 'formatted') {
//           responseContent = data.response; // Use formatted response
//         } else if (data.response && typeof data.response === 'string') {
//           responseContent = data.response; // Use string response as fallback
//         } else {
//           // Final fallback
//           responseContent = "I'm here to help! How can I support you today?";
//         }
...
//       const errorMessage: Message = {
//         content: "I'm having connection issues right now. Please check your internet and try again! 🌐",
//         isUser: false,
//         timestamp: new Date(),
//       };
//       setMessages(prevMessages => [...prevMessages, errorMessage]);
...
const API_URL = 'http://localhost:5000';
// const API_URL = 'https://arogyamind-mini-project.onrender.com';
